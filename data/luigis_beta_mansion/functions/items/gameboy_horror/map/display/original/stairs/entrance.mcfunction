setblock 3707 61 -1 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/entrance_bottom"}
setblock 3707 62 -1 minecraft:redstone_block
setblock 3707 106 -1 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/entrance_top"}
