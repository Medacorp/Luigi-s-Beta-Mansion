setblock 3700 11 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_bottom"}
setblock 3700 12 -40 minecraft:redstone_block
setblock 3700 56 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_top"}
