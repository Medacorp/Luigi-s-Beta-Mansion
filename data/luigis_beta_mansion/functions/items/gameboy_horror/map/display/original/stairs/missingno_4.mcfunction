setblock 3666 61 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_bottom"}
setblock 3666 62 -40 minecraft:redstone_block
setblock 3666 106 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_top"}
