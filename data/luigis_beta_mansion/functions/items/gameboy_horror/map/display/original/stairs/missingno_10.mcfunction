setblock 3700 111 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_bottom"}
setblock 3700 112 -40 minecraft:redstone_block
setblock 3700 156 -40 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_beta_mansion:gameboy_horror_map/stairs/normal_top"}
