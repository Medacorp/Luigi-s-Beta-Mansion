...
execute unless entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:entities/ghost/hurt_pull
execute if entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:entities/ghost/hurt_pull_strong
