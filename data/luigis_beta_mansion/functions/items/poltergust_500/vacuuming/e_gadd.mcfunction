...
execute if entity @e[tag=e_gadd,tag=poltergust,limit=1,tag=vacuuming,scores={Sound=0}] run playsound luigis_beta_mansion:item.poltergust_500.vacuuming player @a[tag=same_room] ~ ~ ~ 1
