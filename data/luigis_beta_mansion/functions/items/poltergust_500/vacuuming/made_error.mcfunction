...
execute if score #e_gadd_amiibo Selected matches 0 if entity @s[scores={Pull=20..},gamemode=!creative] run function luigis_mansion:entities/player/pulled_damage
execute if score #e_gadd_amiibo Selected matches 1 if entity @s[scores={Pull=20..,Room=..0},gamemode=!creative] run function luigis_mansion:entities/player/pulled_damage
