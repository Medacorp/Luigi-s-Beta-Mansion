...
execute if entity @s[tag=ghost,scores={VulnerableTime=2..},tag=!vanish,tag=!being_vacuumed] run function luigis_beta_mansion:items/poltergust_500/latch_onto_ghost