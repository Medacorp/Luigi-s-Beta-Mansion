...
execute positioned as @s[tag=beta_boo,tag=visible] if entity @a[tag=me,distance=..1.2,limit=1] run function luigis_beta_mansion:items/poltergust_500/latch_onto_ghost