...
execute positioned as @s[tag=beta_shining_ghost,tag=visible] if entity @a[tag=me,distance=..1.2,limit=1] run function luigis_mansion:items/poltergust_3000/latch_onto_ghost