...
execute if score #3ds_remake Loaded matches 10.. if score #temp ActionTime matches 10.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.beginner{task_4:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/beginner/task_4
