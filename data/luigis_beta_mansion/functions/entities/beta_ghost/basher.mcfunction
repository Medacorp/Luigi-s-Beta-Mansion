...
execute if entity @s[scores={ActionTime=41}] run playsound luigis_beta_mansion:entity.ghost.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=81}] run playsound luigis_beta_mansion:entity.ghost.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
