...
execute if entity @s[scores={ActionTime=41}] run playsound luigis_beta_mansion:entity.body_slammer.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=41}] as @a[distance=..3,tag=!spectator] run function luigis_mansion:entities/player/scare/bash
execute if entity @s[scores={ActionTime=41}] as @a[distance=3..5,tag=!spectator] run function luigis_mansion:entities/player/scare/normal
...
execute if entity @s[scores={ActionTime=41}] run effect give @a[distance=..5,tag=!spectator] minecraft:instant_damage 1 0 true
execute if entity @s[scores={ActionTime=41}] run scoreboard players set @a[distance=..5,tag=!spectator] ForcedDamage 4
...
execute if entity @s[scores={ActionTime=81}] run playsound luigis_beta_mansion:entity.body_slammer.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
