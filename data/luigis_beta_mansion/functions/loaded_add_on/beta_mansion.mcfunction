...
execute if data luigis_mansion:data current_state.high_scores[{data_index:2}] run advancement grant @a only luigis_beta_mansion:lab/cleared_original_mansion