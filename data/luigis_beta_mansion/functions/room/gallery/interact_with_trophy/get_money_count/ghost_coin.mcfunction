execute store result score #temp Money run data get storage luigis_mansion:data current_state.money_grabbed[0].money.luigis_mansion.luigis_beta_mansion.ghost_coin
