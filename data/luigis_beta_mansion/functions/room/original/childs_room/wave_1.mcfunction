...
execute positioned 741 20 63 run function luigis_beta_mansion:spawn_entities/ghost/body_slammer/orange
execute positioned 744 20 65 if predicate luigis_mansion:50_50 run function luigis_beta_mansion:spawn_entities/ghost/ghost/orange
execute unless entity @e[x=744.5,y=20,z=65.5,distance=..0.7,tag=beta_ghost] positioned 748 20 57 run function luigis_beta_mansion:spawn_entities/ghost/ghost/orange
