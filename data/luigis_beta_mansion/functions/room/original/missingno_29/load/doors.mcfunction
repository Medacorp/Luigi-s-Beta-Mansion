...
tag @e[x=666.5,y=20,z=-72.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add barricade
execute positioned 666 20 -92 rotated 0 0 run function luigis_mansion:spawn_furniture/door/left/pull/mansion/1
tag @e[x=666.5,y=20,z=-91.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add barricade