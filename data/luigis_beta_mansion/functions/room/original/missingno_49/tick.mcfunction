...
execute as @e[x=744,y=28,z=54,dx=22,dy=8,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 65
...
function luigis_beta_mansion:room/original/missingno_49/ghosts
