...
execute positioned 743 11 8 rotated -90 0 run function luigis_mansion:spawn_furniture/door/left/push/mansion/4
execute positioned 743 11 8 rotated -90 0 run function luigis_mansion:spawn_furniture/door_frame/double_windowed
tag @e[x=744.0,y=11,z=8.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add entrance_hallway_3
execute positioned 743 11 9 rotated -90 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/4
execute positioned 743 11 9 rotated -90 0 run function luigis_mansion:spawn_furniture/door_frame/double_windowed
tag @e[x=744.0,y=11,z=9.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add entrance_hallway_3