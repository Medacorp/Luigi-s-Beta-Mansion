...
tag @e[x=737.0,y=20,z=8.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_1_living_room
...
tag @e[x=737.0,y=20,z=9.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_1_living_room
...
tag @e[x=739.5,y=20,z=18.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_1_hallway_2
...
tag @e[x=739.5,y=20,z=0.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add barricade