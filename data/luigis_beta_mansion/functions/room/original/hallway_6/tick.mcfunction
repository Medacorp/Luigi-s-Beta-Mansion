...
execute as @e[x=667,y=10,z=4,dx=11,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 11
...
function luigis_beta_mansion:room/original/hallway_6/ghosts
