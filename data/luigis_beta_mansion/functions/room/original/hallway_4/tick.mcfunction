...
execute as @e[x=686,y=10,z=-23,dx=26,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 9
...
function luigis_beta_mansion:room/original/hallway_4/ghosts
