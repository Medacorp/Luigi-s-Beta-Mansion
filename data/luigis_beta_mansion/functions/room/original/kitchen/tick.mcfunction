...
execute as @e[x=697,y=10,z=61,dx=14,dy=8,dz=31] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 15
...
function luigis_beta_mansion:room/original/kitchen/ghosts
