...
execute positioned 710 11 80 rotated 90 0 run function luigis_mansion:spawn_furniture/door/right/push/mansion/2
execute positioned 710 11 80 rotated 90 0 run function luigis_mansion:spawn_furniture/door_frame/marble
tag @e[x=710.0,y=11,z=80.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add barricade