...
execute unless block 686 112 54 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_beta_mansion:room/original/bed_room_1/search/closet