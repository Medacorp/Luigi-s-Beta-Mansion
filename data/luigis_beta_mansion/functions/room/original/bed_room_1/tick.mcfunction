...
execute as @e[x=682,y=110,z=37,dx=17,dy=8,dz=20] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 6
...
function luigis_beta_mansion:room/original/bed_room_1/ghosts
