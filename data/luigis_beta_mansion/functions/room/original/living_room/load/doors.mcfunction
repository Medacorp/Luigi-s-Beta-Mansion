...
tag @e[x=728.0,y=20,z=27.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_1_living_room
...
tag @e[x=728.0,y=20,z=28.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_1_living_room
...
tag @e[x=714.0,y=20,z=21.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add barricade