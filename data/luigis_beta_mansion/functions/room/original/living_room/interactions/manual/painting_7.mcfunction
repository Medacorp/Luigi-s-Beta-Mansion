...
execute if entity @s[x=724.0,y=21,z=18.0,dx=0,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_beta_mansion:room/original/living_room/search/painting_7