...
execute as @e[x=648,y=10,z=15,dx=12,dy=8,dz=14] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 12
...
function luigis_beta_mansion:room/original/bath_room/ghosts
