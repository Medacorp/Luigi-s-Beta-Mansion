...
execute as @e[x=723,y=28,z=40,dx=16,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 55
...
function luigis_beta_mansion:room/original/missingno_39/ghosts
