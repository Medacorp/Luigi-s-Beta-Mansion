...
execute as @e[x=644,y=101,z=-41,dx=10,dy=8,dz=79] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 39
...
function luigis_beta_mansion:room/original/missingno_23/ghosts
