...
execute as @e[x=682,y=119,z=-10,dx=17,dy=8,dz=35] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 63
...
function luigis_beta_mansion:room/original/missingno_47/ghosts
