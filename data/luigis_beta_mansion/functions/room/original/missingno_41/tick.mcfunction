...
execute as @e[x=736,y=28,z=0,dx=20,dy=8,dz=35] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 57
...
function luigis_beta_mansion:room/original/missingno_41/ghosts
