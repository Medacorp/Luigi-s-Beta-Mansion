...
execute as @e[x=697,y=19,z=-23,dx=15,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 24
...
function luigis_beta_mansion:room/original/missingno_8/ghosts
