...
execute unless block 662 14 36 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_beta_mansion:room/original/lavatory/search/cabinet
execute unless block 662 14 37 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_beta_mansion:room/original/lavatory/search/cabinet