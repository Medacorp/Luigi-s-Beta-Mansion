...
execute as @e[x=686,y=1,z=-6,dx=14,dy=8,dz=18] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 68
...
function luigis_beta_mansion:room/original/missingno_52/ghosts
