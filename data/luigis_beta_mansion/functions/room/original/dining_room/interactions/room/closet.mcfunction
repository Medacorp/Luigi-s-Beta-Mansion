...
execute unless block 699 12 44 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_beta_mansion:room/original/dining_room/search/closet
execute unless block 699 12 42 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_beta_mansion:room/original/dining_room/search/closet