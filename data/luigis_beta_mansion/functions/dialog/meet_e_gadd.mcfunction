...
execute if entity @e[tag=ghost,tag=dialog] run scoreboard players set @a[tag=cold_room_idle] IdleTime 18
execute if entity @e[tag=ghost,tag=dialog] run tag @a[tag=cold_room_idle] remove cold_room_idle
