...
execute if entity @e[tag=ghost,tag=dialog] run tag @a[scores={IdleTime=19..}] remove cold_room_idle
execute if entity @e[tag=ghost,tag=dialog] run scoreboard players set @a[scores={IdleTime=19..}] IdleTime 18
