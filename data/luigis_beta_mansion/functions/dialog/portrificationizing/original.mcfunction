...
execute if entity @s[scores={Dialog=830},tag=ending] if data storage luigis_mansion:data current_data.high_scores[0] run function luigis_mansion:dialog/portrificationizing/get_high_score
