summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_beta_mansion:item.ghost_coin"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:9}}],Tags:["item","ghost_coin","this_entity"],DisabledSlots:2039583}
